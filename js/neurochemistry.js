...
export const SLIDE_DECK_SPECS = {
    ...
    slides: [
        ...
        { number: 8, name: 'End Card (Optional)', content: 'Camino Coaching logo. "85 five-star reviews. 4.9/5."' }
    ]
};
...
export const VIDEO_TOPICS = [
    ...
    { topic: '808 personal bests in our data. The chemical pattern they all share.', chemical: 'flow-cocktail' }
];
