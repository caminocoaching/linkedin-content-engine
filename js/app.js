        ...
        ${isConfirmed ? `
          <div style="padding:0.5rem 1.25rem;background:rgba(0,191,165,0.04);border-top:1px solid rgba(0,191,165,0.1);">
            <div style="display:flex;align-items:center;gap:0.5rem;flex-wrap:wrap;">
              ...
              <a href="https://manus.im/app/project/8NrSN7QhXFa73NHttThdvi" target="_blank" rel="noopener" style="font-size:0.72rem;padding:0.25rem 0.6rem;background:rgba(0,191,165,0.12);color:var(--neuro-teal,#00BFA5);border:1px solid rgba(0,191,165,0.3);border-radius:5px;text-decoration:none;font-weight:700;">🎨 Manus Slides</a>
